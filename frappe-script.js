var tasks = [
	{
		...
		resources: "Director, Support Staff, Field Organizers",
	},
	{
		id: "Task 2",
	...
	},
	{
		...
		description:
			"Email approved by Director of Special Projects and Future Majority Staff",
		resources: "Support Staff, Director",
	},
	{
	...
	},
	{
		...
		custom_class: "support",
		description:
			"Support staff will draft a recruitment email that will be sent to incumbent candidates and candidates across Canada.",
	...
	},
	{
		...
		custom_class: "bar-milestone",
		description:
			"Email approved by Director of Special Projects and all Future Majority Staff",
		resources: "Director",
	},
	{
		id: "Task 7",
		...
		custom_class: "field",
		description:
			"Regional Field Organizers will activate Future Majoirty Membership in their respective regions. They will also begin develop a Recruit List to solicit new Future Majority Members",
		resources: "Support Staff",
	},
	{
		id: "Task 8",
		...
		custom_class: "director",
		description:
			"The 20 incumbent candidates are contacted and brought onboard to participate in the project.",
		resources: "Director, Support Staff",
	},
	{
		id: "Task 9",
		...
		custom_class: "support",
		description:
			"Follow-up with 20 incumbent candidates to make sure they will participate.",
		resources: "Support Staff",
	},
	{
		id: "Task 10",
		...
		custom_class: "support",
		description:
			"Amplify incumbent videos and microsite through social media channels",
		resources: "Support Staff",
	},
	{
		id: "Task 16",
	...
	},
	{
		...
		custom_class: "field",
		description:
			"Field organizer's will identify the priorities of young canadians in their Respective regions.",
	...
	},
	{
		...
		custom_class: "field",
		description:
			"Field Organizers contact candidates in their respective regions to discuss the project and brought onboard to participate.",
		resources: "Field Organizers",
	},
	{
		id: "Task 13",
	...
	},
	{
		...
		custom_class: "field",
		description:
			"Collaborate with regional Future Majority Membership to generate earned regional media.",
		resources: "Field Organizers, Director, Support Staff",
	},
	{
		id: "Task 15",
		...
		custom_class: "bar-milestone",
		description:
			"Successfully obtain 1,000 1-minute videos and post on microsite.",
		resources: "Director, Support Staff, Field Organizers",
	},
	{
		id: "Task 17",
		...
		custom_class: "director",
		description:
			"Connect with candidates in swing electoral districts and determine their interest in participating in a (virtual) debate",
		resources: "Director, Support Staff, Field Organizers",
	},
	{
		id: "Task 18",
		...
		custom_class: "bar-milestone",
		description:
			"Choose 5 electoral districts and confirm their participation a debate",
		resources: "Director, Support Staff, Field Organizers",
	},
	{
		id: "Task 19",
