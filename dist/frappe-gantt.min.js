var Gantt = function () {
    ...
    class p {
        ...
        setup_gantt_dates() {
            ...
            this.gantt_start = e.start_of(this.gantt_start, "day"), this.gantt_end = e.start_of(this.gantt_end, "day"), this.view_is([d.QUARTER_DAY, d.HALF_DAY]) ? (this.gantt_start = e.add(this.gantt_start, -2, "day"), this.gantt_end = e.add(this.gantt_end, 2, "day")) : this.view_is(d.MONTH) ? (this.gantt_start = e.start_of(this.gantt_start, "year"), this.gantt_end = e.add(this.gantt_end, 1, "year")) : this.view_is(d.YEAR) ? (this.gantt_start = e.add(this.gantt_start, -2, "year"), this.gantt_end = e.add(this.gantt_end, 2, "year")) : (this.gantt_start = e.add(this.gantt_start, -1, "month"), this.gantt_end = e.add(this.gantt_end, 1, "month"))
        }
        setup_date_values() {
            this.dates = [];
            let t = null;
